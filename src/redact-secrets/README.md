...
The `redact-secrets` extension prevents secret-like data from being written into files and reduces the chance that sensitive values leak into model-visible tool output.
...
- `patterns.ts` — known secret regex catalog
